    ...
    <div className="property-container">
        { propertyName && (
                ...
                <h6 className="property-location">
                    ...
                    <span className="location">{`${address.area}, ${address.city}, ${address.pincode}, ${address.state}`}
                    </span>
               ...
               <div className="middle-container row">
                <div className="des-and-amenities col-md-8 col-sm-12 col-12">
                  ...
                  <p className="property-description">
                    {description} <br /><br />
                    maximum number of guests: {maximumGuest} 
                  </p>
                  <hr />
               ...
               <div className="property-map">
                <div className="map-image-exinfo-container row">
                  <div className="map-image-container col-md-6 col-sm-12">
                    <h2 className="map-header">Where you will be</h2>
                    <MapComponent address={address} />
                  </div>
                  <div className="extra-info col-md-6 col-sm-12">
